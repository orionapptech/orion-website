...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-gradient-to-br from-primary/5 via-white to-purple-500/5 pb-16 pt-[120px] dark:from-gray-dark dark:via-gray-dark dark:to-primary/5 md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[900px] text-center">
                {/* Badge */}
                <div className="animate-fade-in-up mb-6 inline-flex items-center gap-2 rounded-full bg-primary/10 backdrop-blur-sm border border-primary/20 px-4 py-1.5 text-sm font-medium text-primary">
                ...
                {/* Trust indicators */}
                <div className="animate-fade-in-up mb-10 flex flex-wrap items-center justify-center gap-6 text-sm text-body-color dark:text-body-color-dark">
                ...
                <div className="animate-scale-in flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="/contact"
                    className="hover-lift rounded-lg bg-primary px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
                    Start Your Project
                  </Link>
                  <Link
                    href="/services/website-development"
                    className="glass-effect hover-lift inline-block rounded-lg border-2 border-primary bg-transparent px-8 py-4 text-base font-semibold text-primary duration-300 ease-in-out hover:bg-primary hover:text-white"
                  >
                    Explore Services
                  </Link>
                </div>
